# Generated by Django 4.0.6 on 2023-04-03 21:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='service',
            name='priceType',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='priceTypee', to='DataEntry.typee'),
        ),
        migrations.AddField(
            model_name='service',
            name='supervisor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='supervisor', to='DataEntry.employee'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subService', models.ManyToManyField(default='-', to='DataEntry.subservice')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subServices', models.ManyToManyField(related_name='services', to='DataEntry.subservice')),
            ],
            options={
                'abstract': False,
            },
